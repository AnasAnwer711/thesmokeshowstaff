...
<br>
<br>
Great news - You have been invited to a job!
<a href="{{ env('APP_URL') ?? 'https://thesmokeshowstaff.datanetbpodemo.com' }}/applications" target="_blank">
    Click
    here
</a>
to ACCEPT the job.
...
<br>
<br>
Be aware that you have 48 hours to respond. Don't wait too long to <a
    href="{{ env('APP_URL') ?? 'https://thesmokeshowstaff.datanetbpodemo.com' }}/applications"
    target="_blank" >ACCEPT</a>
otherwise someone else might get the job before you.
<br>
<br>
Thanks,
<br>
